...
const projects = [
  ...
  {
    title: "Request Management UI - Personal",
    description:
...
const Projects = () => {
  return (
    <div
      className="text-black bg-yellow-300 h-screen items-center px-8 py-8 sm:py-16 xl:px-16 w-screen mx-auto relative z-10"
      id="projects"
    >
